...
<%@ page import="static application.utils.Constant.UPDATE_USER" %>
...
<%
    ...
    UserDTO userDTO = (UserDTO) request.getAttribute(UPDATE_USER);
if (userDTO != null) { %>
...
<div>
    <form style="margin-left: 40%; margin-top: -1vw; width: 21vw; margin-bottom: -1vw; display: block;"
          method="post" action="${pageContext.request.contextPath}updateUserFromM" >
