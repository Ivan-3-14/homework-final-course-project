...
<a href='${pageContext.request.contextPath}newManager'> Создать нового менеджера
</a>
</br>
</br>
<a href='${pageContext.request.contextPath}changePrice'> Изменить цены
</a>
</br>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border: none; width: 2vw">
                <form style="margin: 2px" action="${pageContext.request.contextPath}toUpdateManager" method="post">
            ...
            <td style="border: none; width: 2vw">
                <form style="margin: 2px" action="${pageContext.request.contextPath}deleteManager" method="post">
