...
<div >
    <form method="post" action="${pageContext.request.contextPath}/signUp"
        ...
        <div class="input-field">
            ...
            <input type="text" style="width: 200px; height: 30px;" name="email" placeholder="Email">
        </div>
        ...
        <div class="input-field">
            ...
            <p style="color: #ec6767; margin-left: 14px">Упс, проверьте данные!</p>
            <% } %>
        <button>Войти</button>

        </br>
        <a style="margin-left: 120px;" href="${pageContext.request.contextPath}/forgotPass">Забыли пароль?</a>
    ...
    <img src="img/autorization.jpg" width=30% height="540" alt="вход в Морию" style=" margin-left: 25.5%">
</div>
</body>
