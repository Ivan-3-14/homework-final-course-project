...
public class AutoTransportDAOImpl extends DAOImpl<AutoTransport> implements AutoTransportDAO {
    ...
    public Long getCountOfCarCapacity(int capacity) {
        ...
        AutoCapacityDAO autoCapacityDAOImpl = new AutoCapacityDAOImpl();
