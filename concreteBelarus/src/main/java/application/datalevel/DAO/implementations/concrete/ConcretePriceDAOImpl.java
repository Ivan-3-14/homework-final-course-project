...
public class ConcretePriceDAOImpl extends DAOImpl<ConcretePrice> implements ConcretePriceDAO {
    ...
    @Override
    public List<ConcretePrice> getAllConcretePrice() {
        logger.log(Level.INFO, START_GET_ALL_CONCRETE_PRICE);
        List<ConcretePrice> list = new ArrayList<>();
        try {
